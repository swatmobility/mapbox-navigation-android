...
import com.mapbox.navigation.dropin.component.camera.CameraPaddingUpdater
...
internal class MapBinder(
    ...
    override fun bind(value: ViewGroup): MapboxNavigationObserver {
        val navigationStateViewModel = navigationViewContext.viewModel.navigationStateViewModel
        return navigationListOf(
            CameraPaddingUpdater(
                mapView,
                binding,
            ...
            reloadOnChange(navigationStateViewModel.state) {
                when (it) {
            ...
            ) { _, arrowOptions, navigationState ->
