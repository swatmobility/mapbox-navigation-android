...
class CarNavigationCamera(
    ...
    private val initialCameraOptions: CameraOptions? = CameraOptions.Builder()
        ...
        .build()
) : DefaultMapboxCarMapGestureHandler(), MapboxCarMapObserver {
    private var mapboxCarMapSurface: MapboxCarMapSurface? = null
    private lateinit var navigationCamera: NavigationCamera
    private lateinit var viewportDataSource: MapboxNavigationViewportDataSource

    private val _carCameraMode = MutableStateFlow<CarCameraMode?>(value = null)
    val customCameraMode: StateFlow<CarCameraMode?> = _carCameraMode
    ...
    override fun onAttached(mapboxCarMapSurface: MapboxCarMapSurface) {
        ...
        mapboxCarMap.setGestureHandler(this)
    ...
    override fun onScale(
        ...
        val handleZoom = toZoom.coerceIn(MIN_ZOOM_OUT, MAX_ZOOM_IN) == toZoom
        if (handleZoom) {
